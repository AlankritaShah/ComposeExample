package com.alankrita.woof.data

import androidx.annotation.DrawableRes
import androidx.annotation.StringRes
import com.alankrita.woof.R
...
val dogs = listOf(
    ...
    Dog(R.drawable.bella, R.string.dog_name_5, 8, R.string.dog_description_5),
    Dog(R.drawable.bella, R.string.dog_name_6, 14, R.string.dog_description_6),
    Dog(R.drawable.bella, R.string.dog_name_7, 2, R.string.dog_description_7),
    Dog(R.drawable.bella, R.string.dog_name_8, 7, R.string.dog_description_8),
    Dog(R.drawable.bella, R.string.dog_name_9, 4, R.string.dog_description_9)
)